            ...
            <div class="col-md-7">
                <form action="/item?id=<?= htmlspecialchars($item[0]['id']) ?>" method="post">
                    <div class="single-product-details">
                        ...
                        <p class="product-price">Rp<?= number_format($item[0]['price'], 2) ?></p>
                        ...
                        <?php if($inCart): ?>
							<button name="cart" type="submit" class="btn btn-main text-center" disabled>Tambah ke Keranjang</button>
						<?php else: ?>
							<button name="cart" type="submit" class="btn btn-main text-center">Tambah ke Keranjang</button>
						<?php endif ?>
                    </div>
                </form>
            </div>
