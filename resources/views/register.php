    ...
    <div class="container">
        ...
        <?php if($error): ?>
            <div class="row mt-30">
                <div class="col-xs-12">
                    <div class="alertPart">
                    <div class="alert alert-danger alert-common" role="alert"><i class="tf-ion-close-circled"></i><span>Registrasi Gagal!</span> Email sudah terdaftar</div>
                    </div>
                </div>		
            </div>
        <?php endif ?>
        <div class="col-md-6 col-md-offset-3">
            ...
            <form class="text-left clearfix" method="post" action="<?= $_SERVER['REQUEST_URI'] ?>" >
                ...
                <div class="form-group">
                    <input type="text" name="lastname" class="form-control"  placeholder="Nama Akhir">
                </div>
                <div class="form-group">
                ...
                <div class="text-center">
                    <button name="register" type="submit" class="btn btn-main text-center" >Registrasi</button>
                </div>
            </form>
            </div>
        </div>
