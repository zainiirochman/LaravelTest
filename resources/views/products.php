					...
					<div class="panel-group commonAccordion" id="accordion" role="tablist" aria-multiselectable="true">
						...
						<?php else: ?>
							<form action="/products" method="post">
								<?php CSRF::csrfInputField() ?>
							    <div class="form-group">
								    <input name="q" type="search" class="form-control" placeholder="Cari...">
						<?php endif ?>
							    </div>
							<div class="text-center">
								<button name="search" type="submit" class="btn btn-main btn-small">Cari</button>
							</div>
						</form>
					</div>
					...
					<?php else: ?>
						<div class="col-md-6 col-md-offset-3">
							<div class="block text-center">
								...
								<h2 class="text-center">Tidak ditemukan.</h2>
								<a href="/products" class="btn btn-main mt-20">Kembali Berbelanja</a>
							</div>
						</div>
					<?php endif ?>
