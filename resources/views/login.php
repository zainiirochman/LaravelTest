        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form class="text-left clearfix" method="post" action="<?= $_SERVER['REQUEST_URI'] ?>" >
                ...
                <div class="text-center">
                    <button name="login" type="submit" class="btn btn-main text-center" >Masuk</button>
                </div>
            </form>
            <p class="mt-20">Belum punya akun ?<a href="/register"> Buat Akun Baru</a></p>
            <p class="mt-20"><a href="/forgot-password">Lupa Kata Sandi?</a></p>
            </div>
        </div>
        </div>
    </div>
