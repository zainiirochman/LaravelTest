...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>TomadOn | Reset Password</title>
        ...
        <?php if(isset($success)): ?>
            ...
            <?php else: ?>
                <div class="alert alert-info alert-common alert-dismissible" role="alert">
                    ...
                    <i class="tf-ion-android-checkbox-outline"></i>Kode tidak valid/kadaluarsa.
                </div>
            <?php endif ?>
        <?php else: ?>
            <div class="col-md-6 col-md-offset-3">
                ...
                <form class="text-left clearfix" method="post" action="<?= $_SERVER['REQUEST_URI'] ?>">
                    ...
                    <?php CSRF::csrfInputField() ?>
                    <div class="form-group">
                    <input type="text" name="code" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Kode">
                    </div>
                    <div class="text-center">
